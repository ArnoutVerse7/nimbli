...
export default function PinCreatePage({ onNavigate }) {
  ...
  return (
    <PageShell>
      ...
      <div className="page-row page-row--spaced">
        <Button type="button" onClick={() => onNavigate('profileSelection')}>
          Ga verder
        </Button>
        <Button variant="secondary" type="button" onClick={() => onNavigate('signup')}>
          annuleer
        </Button>
      </div>
    </PageShell>
