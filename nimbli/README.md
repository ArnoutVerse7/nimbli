...
5. Stel bij Authentication > URL Configuration de Site URL in op `http://localhost:5173` en voeg `http://localhost:5173/**` toe als Redirect URL.
6. Schakel Email Authentication in en gebruik minimaal acht tekens voor wachtwoorden.
